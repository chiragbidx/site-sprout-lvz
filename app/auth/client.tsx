...
export default function Client({ redirectTo, flashStatus, flashMessage }: ClientProps) {
  ...
  const content = useMemo(() => {
    if (mode === "signup") {
      return {
        id: "signup",
        title: "Create your ClientFlow account",
        description: "Start managing contacts, deals, and your sales pipeline.",
        button: "Create Account",
        link: {
          text: "Already have an account? Sign in.",
          href: "#signin",
        },
        helper: "Secure access to your ClientFlow workspace.",
      };
    }
    ...
    return {
      ...
      description: "Welcome back! Organize your clients and deals.",
      button: "Sign In",
      link: {
        text: "Don't have an account? Get started free.",
        href: "#signup",
      },
      helper: "Secure access to your ClientFlow workspace.",
    };
          ...
          <div className="relative z-10 flex h-full flex-col justify-between">
            <div className="space-y-4">
              ...
              <h1 className="max-w-sm text-4xl font-semibold leading-tight tracking-tight">
                Grow relationships, track deals, and boost team productivity.
              </h1>
              <p className="max-w-md text-sm text-muted-foreground">{content.helper}</p>
            </div>
